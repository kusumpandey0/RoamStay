                        ...
                        {pendingRooms.map(room => (
                            <div key={room._id} className="pending-item">
                                ...
                                <div className="actions">
                                    <button
                                        className="approve"
                                        onClick={() => handleApproval(room._id, "rooms", "approved")}
                                    >
                                        <FaCheck /> Approve
                                    </button>
                                    <button
                                        className="reject"
                                        onClick={() => handleApproval(room._id, "rooms", "rejected")}
                                    >
                                        <FaTimes /> Reject
                                    </button>
                                </div>
                        ...
                        {pendingDestinations.map(dest => (
                            <div key={dest._id} className="pending-item">
                                ...
                                <div className="actions">
                                    <button
                                        className="approve"
                                        onClick={() => handleApproval(dest._id, "destinations", "approved")}
                                    >
                                        <FaCheck /> Approve
                                    </button>
                                    <button
                                        className="reject"
                                        onClick={() => handleApproval(dest._id, "destinations", "rejected")}
                                    >
                                        <FaTimes /> Reject
                                    </button>
                                </div>
                                ...
                                <div className="item-details">
                                    ...
                                    <div className="info">
                                        ...
                                        <div className="documents">
                                            <a href={`${url}/${guide.certificate}`} target="_blank">View Certificate</a>
                                            <a href={`${url}/${guide.citizenship}`} target="_blank">View Citizenship</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="actions">
                                    <button
                                        className="approve"
                                        onClick={() => handleApproval(guide._id, "guides", "approved")}
                                    >
                                        <FaCheck /> Approve
                                    </button>
                                    <button
                                        className="reject"
                                        onClick={() => handleApproval(guide._id, "guides", "rejected")}
                                    >
                                        <FaTimes /> Reject
                                    </button>
                                </div>
